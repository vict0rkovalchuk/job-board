...
export default function JobDetails() {
  return (
    <div className="wrapper pt-14 pb-40 relative">
      <div className="container max-w-1440px my-0 mx-auto">
        <div className="details max-w-1260px my-0 mx-auto flex gap-20">
          <div className="details__info w-793px pl-5 pr-14">
            <div className="details__header flex justify-between items-center border-b border-solid border-slate-700/0.13">
              <h2 className="font-bold text-[28px] tracking-0.413333px text-3A4562">
                Job Details
              </h2>
              <div className="details__actions flex gap-6 items-center">
                <div className="_icon-save flex gap-4 items-center text-xl text-70778B">
                  <span className="text-lg text-3A4562">Save to my list</span>
                </div>
                <div className="_icon-share flex gap-4 items-center text-xl text-70778B">
                  <span className="text-lg text-3A4562">Share</span>
                </div>
              </div>
            </div>
            <button className="details__apply mt-10 bg-384564 text-white py-18px px-30px rounded-lg">
              Apply now
            </button>
            <div className="mt-8 flex gap-14 justify-between ">
            ...
            <button className="details__apply  bg-384564 text-white py-18px px-30px rounded-lg">
              Apply now
            </button>
            ...
            <div className="details__types mt-4">
              ...
              <div className="details__types-list mt-2.5 flex gap-2 ">
            ...
            <div className="details__benefits mt-4">
              ...
              <div className="details__benefits-list mt-2.5 flex gap-2 ">
            ...
            <div className="images mt-5 flex gap-2.5">
            ...
            <Link
              to="/job-board/"
              className="details__return mt-24 flex justify-center ml-minus80px items-center gap-5 rounded-lg bg-E4E5EA w-72 py-5 px-6 font-semibold"
            >
